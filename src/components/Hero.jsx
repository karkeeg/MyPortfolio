...
const Hero = () => {
  return (
    <section
      id="home"
      className="h-screen bg-cover bg-center relative flex flex-col justify-center items-center text-center overflow-hidden"
    ...
    >
      ...
      >
        ...
        <p className="max-w-2xl text-md md:text-lg text-gray-600 dark:text-gray-400 mb-8 px-4">
          I build beautiful and functional websites with a focus on performance and seamless user experience. Let's bring ideas to life with code and creativity!
        </p>
        ...
        <div className="flex gap-6 mt-8 justify-center">
          <a
            ...
            className="text-gray-600 dark:text-gray-300 hover:text-purple-600 dark:hover:text-purple-400 text-2xl transition"
          >
            <FaGithub />
          </a>
          <a
